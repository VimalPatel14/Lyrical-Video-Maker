 ...
 */
public class PixelateTextPVEMLyricalStatusMaker implements PVEMLyricalStatusMaker__IVText {
    ...
    float charTime = 2000;
    int mostCount = 20;
    PVEMLyricalStatusMaker_TextViewV mLyricalVidMakerHTextView;
    ...
    private List<PVEMLyricalStatusMaker_CharDiffRes> differentList = new ArrayList<>();
    ...
    public void init(PVEMLyricalStatusMaker_TextViewV lyricalVidMakerHTextView, AttributeSet attrs, int defStyle) {
        ...
        paint.setTypeface(lyricalVidMakerHTextView.getTypeface());

        oldPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        oldPaint.setColor(Color.BLACK);
        oldPaint.setStyle(Paint.Style.FILL);
        oldPaint.setTypeface(lyricalVidMakerHTextView.getTypeface());
        ...
        WindowManager windowManger = (WindowManager) lyricalVidMakerHTextView.getContext()
                .getSystemService(Context.WINDOW_SERVICE);
        windowManger.getDefaultDisplay().getMetrics(metrics);

        textSize = lyricalVidMakerHTextView.getTextSize();
    ...
    private void calc() {
        textSize = mLyricalVidMakerHTextView.getTextSize();
        ...
        oldStartX = (mLyricalVidMakerHTextView.getWidth() - oldPaint.measureText(mOldText.toString())) / 2f;

        startX = (mLyricalVidMakerHTextView.getWidth() - paint.measureText(mText.toString())) / 2f;
        startY = (int) ((mLyricalVidMakerHTextView.getHeight() / 2) - ((paint.descent() + paint.ascent()) / 2));
