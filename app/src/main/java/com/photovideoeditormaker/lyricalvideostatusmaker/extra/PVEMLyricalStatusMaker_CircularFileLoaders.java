package com.photovideoeditormaker.lyricalvideostatusmaker.extra;
...
public class PVEMLyricalStatusMaker_CircularFileLoaders extends AppCompatImageView {
    ...
    public PVEMLyricalStatusMaker_CircularFileLoaders(final Context context) {
        this(context, null);
    }

    public PVEMLyricalStatusMaker_CircularFileLoaders(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PVEMLyricalStatusMaker_CircularFileLoaders(Context context, AttributeSet attrs, int defStyleAttr) {
